    ...
    <div class="all-content-wrapper">
                                        ...
                                        <div class="header-top-menu tabl-d-n">
                                            <ul class="nav navbar-nav mai-top-nav">
                                                <li class="nav-item"><a href="#"
                                                        class="nav-link"><strong>TestApp</strong></a>
                                                </li>
                                                <li class="nav-item"><a href="selectare_examen.php" class="nav-link">Selectează
                                                        examenul</a>
                                                </li>
                                                <li class="nav-item"><a href="rezultat_examen_vechi.php" class="nav-link">Ultimele rezultate</a>
                                                </li>
        ...
        <script type="text/javascript">
            ...
            function timer() {
                ...
                xmlhttp.open("GET", "forajax/incarcare_timp.php", true);
                xmlhttp.send(null);
            }
